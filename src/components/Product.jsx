...
function Product({ d }) {
  ...
  return (
    <div>
      <picture>
        <source srcSet={d.image.mobile} media="(max-width: 450px)" />
        <source srcSet={d.image.tablet} media="(max-width: 800px)" />
        <source srcSet={d.image.desktop} media="(min-width: 801px)" />
        ...
        <img
          src={d.image.desktop}
          alt={d.name}
          className={`product-image ${isAdded ? "border-red" : ""}`}
        />
      </picture>
